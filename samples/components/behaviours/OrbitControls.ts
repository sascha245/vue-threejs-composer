...
export class OrbitControls extends THREE.EventDispatcher {
  ...
  constructor(
    ...
    // this.onTouchMove = () => void;

    this.onTouchMove = (evt: Event) => {
      const event = evt as ThreeEvent;
